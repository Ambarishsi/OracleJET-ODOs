...
var DomScroller = function (element, dataprovider, options) {
  ...
  $(this._getScrollEventElement()).on({
    'scroll.domscroller': this._scrollListener,
    'wheel.domscroller': this._wheelListener,
    'mousedown.domscroller': this._mouseDownListener
  });
};
 ...
 * @private
 */
DomScroller.prototype.disableEventListeners = function () {
 ...
 * @private
 */
DomScroller.prototype.enableEventListeners = function () {
  $(this._getScrollEventElement()).on({
    'scroll.domscroller': this._scrollListener,
    'wheel.domscroller': this._wheelListener,
    'mousedown.domscroller': this._mouseDownListener
