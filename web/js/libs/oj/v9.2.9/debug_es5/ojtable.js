...
Table.prototype._refreshTableDimensions = function (width, height, skipRequiredCheck) {
  ...
  this._registerScrollListeners(); // dom scroller must be registered AFTER scroll listeners to avoid race conditions


  if (this._domScroller != null) {
    this._domScroller.enableEventListeners();
  }
};
/**
 * @private
...
Table.prototype._restoreScrollLeft = function (scrollLeft) {
...
Table.prototype._removeTableDimensionsStyling = function () {
  this._unregisterScrollListeners(); // dom scroller must be registered AFTER scroll listeners to avoid race conditions


  if (this._domScroller != null) {
    this._domScroller.disableEventListeners();
  }
...
Table.prototype._registerScrollListeners = function () {
...
Table.prototype._unregisterScrollListeners = function () {
  var scroller = this._getScroller();
